...
public class CannedResponseInterceptorTest {
	...
	public void shouldReturnSequentialFromIDataString() throws IOException {
		String[] lst = new String[] {"<IDataXMLCoder version=\"1.0\"><record javaclass=\"com.wm.data.ISMemDataImpl\"><value name=\"option\">a</value></record></IDataXMLCoder>","<IDataXMLCoder version=\"1.0\"><record javaclass=\"com.wm.data.ISMemDataImpl\"><value name=\"option\">b</value></record></IDataXMLCoder>"};
