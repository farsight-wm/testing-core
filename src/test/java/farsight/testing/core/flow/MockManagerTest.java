...
import static farsight.testing.constants.ServiceParameters.ADVICE_ID;
import static farsight.testing.constants.ServiceParameters.CONDITION;
import static farsight.testing.constants.ServiceParameters.ENABLED;
import static farsight.testing.constants.ServiceParameters.EXCEPTION;
import static farsight.testing.constants.ServiceParameters.INTERCEPT_POINT;
import static farsight.testing.constants.ServiceParameters.RESPONSE;
import static farsight.testing.constants.ServiceParameters.SCOPE;
import static farsight.testing.constants.ServiceParameters.SERVICE_NAME;
...
public class MockManagerTest {
	...
	private FarsightChainProcessor acpMock;
	private MockManager mm;

	@Before
	public void setUp() {
		acpMock = mock(FarsightChainProcessor.class);
		mm = new MockManager();
		FarsightChainProcessor.setInstance(acpMock);
	}
